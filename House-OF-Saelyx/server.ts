...
const LOCAL_CSP =
  ...
  "img-src 'self' data: blob: https://images.unsplash.com https://firebasestorage.googleapis.com https://*.public.blob.vercel-storage.com https://*.googleusercontent.com https://*.fbcdn.net https://*.fbsbx.com https://*.paypal.com https://*.paypalobjects.com https://pay.google.com; " +
