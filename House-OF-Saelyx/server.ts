...
const LOCAL_CSP =
  ...
  "img-src 'self' data: blob: https://images.unsplash.com https://firebasestorage.googleapis.com https://*.public.blob.vercel-storage.com https://*.googleusercontent.com https://*.fbcdn.net https://*.fbsbx.com https://*.paypal.com https://*.paypalobjects.com https://www.gstatic.com; " +
  "connect-src 'self' https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://firebaseinstallations.googleapis.com https://*.googleapis.com https://*.firebaseapp.com https://*.paypal.com https://*.paypalobjects.com https://google.com https://account.google.com https://www.google.com https://accounts.google.com wss://*.googleapis.com http://localhost:3000 ws://localhost:3000; " +
