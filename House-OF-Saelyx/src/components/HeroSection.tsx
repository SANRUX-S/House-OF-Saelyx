...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-[100dvh] min-h-[660px] max-h-[1100px] overflow-hidden bg-[#181614] select-none">
      ...
      >
        <img
          src="https://res.cloudinary.com/qt3rdzmd/image/upload/c_scale,w_2000/e_gen_restore/e_sharpen:100/f_auto/q_auto:best/v1788705356/saelyxe/hero/saelyxe-hero-2026-09-06.webp"
