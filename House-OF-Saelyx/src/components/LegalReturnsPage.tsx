      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-[#F3EDE4] border border-[#E2D8C9] p-4 rounded-xl space-y-1.5">
            ...
            <h4 className="font-serif text-sm font-semibold text-[#1A1816]">Online Payment Refunds</h4>
        ...
        <div className="space-y-10 text-sm text-[#3A332C] leading-relaxed font-normal">
          ...
          <section className="bg-white border border-[#E6DCCF] p-6 sm:p-8 rounded-2xl shadow-sm space-y-4">
            ...
            <p>
              If approved, the eligible refund will be processed through the original payment method or the applicable payment processor, through PayPal or Payzy where applicable.
            </p>
            <p>
          ...
          <section className="bg-white border border-[#E6DCCF] p-6 sm:p-8 rounded-2xl shadow-sm space-y-4">
            ...
            <p>
              If your order arrives <strong className="font-semibold text-[#1A1816]">damaged, defective, or incorrect</strong>, please contact SAELYXE customer support as soon as possible after delivery.
            </p>
            <p>
          ...
          <section className="bg-white border border-[#E6DCCF] p-6 sm:p-8 rounded-2xl shadow-sm space-y-4">
            ...
            <p>
              Where the return is due to an incorrect item, defective product, or another confirmed error by SAELYXE, we will determine the appropriate shipping arrangement.
            </p>
          </section>
          ...
          <section className="bg-[#FAF6F0] border border-[#DFD5C6] p-6 sm:p-8 rounded-2xl space-y-4">
            <div className="flex items-center gap-3 border-b border-[#E3D8C8] pb-4">
              ...
              <h2 className="font-serif text-xl font-semibold text-[#1A1816]">
                Payment Methods & Provider Refunds
              </h2>
            </div>
            <p>
              SAELYXE may use <strong className="font-semibold text-[#1A1816]">PayPal or Payzy</strong> for online checkout payments where those methods are displayed.
            </p>
            <p>
            ...
            <p>
              SAELYXE does not request or store customers' full card details for payment processing. Payment card information is handled through the applicable payment service provider.
            </p>
            <p className="text-xs text-[#5C5042] leading-relaxed">
              Where a refund relates to a PayPal or Payzy transaction, the refund will be handled through the applicable provider and merchant procedures. The time required for the refunded amount to appear in a customer's account may depend on the payment provider, issuing bank, card issuer, or Payzy account process.
            </p>
          </section>
          ...
          <section className="bg-white border border-[#E6DCCF] p-6 sm:p-8 rounded-2xl shadow-sm space-y-4">
            ...
            <p className="text-xs text-[#665A4E]">
              The actual time for a refunded amount to appear in your account may vary depending on your bank, card issuer, PayPal, Payzy, or other applicable payment provider.
            </p>
          </section>
          ...
          <section className="bg-white border border-[#E6DCCF] p-6 sm:p-8 rounded-2xl shadow-sm space-y-4">
            ...
            <p>
              SAELYXE is not responsible for issues caused by incorrect or incomplete customer-provided information, subject to applicable consumer rights and law.
            </p>
